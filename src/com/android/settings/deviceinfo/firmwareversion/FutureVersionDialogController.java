...
public class FutureVersionDialogController {
    ...
    private static final String TAG = "futureDialogCtrl";
    ...
    public FutureVersionDialogController(FirmwareVersionDialogFragment dialog) {
        mDialog = dialog;
    ...
    /**
     * Populates the Future version field in the dialog.
     */
